...
**Next action:** Editor is feature-complete (Phases 0–8 + every Phase 8 extra). Pick a new direction, or grow the bundled spawner-template set (`assets/spawner_templates/`).
