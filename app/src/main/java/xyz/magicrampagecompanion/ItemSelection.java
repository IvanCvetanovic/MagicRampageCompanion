...
public class ItemSelection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (buttonId == 1) {
            ...
            armorList.add(createArmor(R.string.elite_soldier_set, Elements.NEUTRAL, false, 15, 25, 3, 3, 2, 0, 30, 0, 20, 20, 0, 0, R.drawable.armor_elite_soldier_set));
            ...
            armorList.add(createArmor(R.string.santa_claus, Elements.LIGHT, true, 30, 30, 0, 8, 20, 0, 0, 0, 0, 0, 0, 0, R.drawable.armor_santa_claus));
            ...
            armorList.add(createArmor(R.string.jungle_assassin_suit, Elements.EARTH, false, 25, 79, 9, 4, 4, 45, 0, 35, 35, 0, 40, 0, R.drawable.armor_jungle_assassin_suit));
            ...
            armorList.add(createArmor(R.string.tunic_of_endless_justice, Elements.LIGHT, false, 24, 110, 15, 5, 3, 180, 70, 130, 0, 0, 0, 70, R.drawable.armor_tunic_of_endless_justice));
            ...
            armorList.add(createArmor(R.string.gatekeepers_bionic_arm, Elements.AIR, false, 25, 115, 15, 6, 2, 0, 200, 0, 40, 0, 20, 0, R.drawable.armor_gatekeepers_bionic_arm));
            ...
            armorList.add(createArmor(R.string.death_stalker, Elements.DARKNESS, false, 26, 119, 15, 2, 0, 160, 0, 110, 130, 0, 0, 150, R.drawable.armor_death_stalker));
            ...
            armorList.add(createArmor(R.string.tunic_of_frozen_voices, Elements.WATER, true, 30, 138, 15, 0, 0, 170, 0, 120, 130, 0, 0, 150, R.drawable.armor_tunic_of_frozen_voices));
            ...
            armorList.add(createArmor(R.string.barrenlands_bandit, Elements.NEUTRAL, false, 34, 156, 15, 2, 3, 70, 180, 0, 130, 0, 150, 0, R.drawable.armor_barrenlands_bandit));
            ...
            armorList.add(createArmor(R.string.robe_of_imminent_fires, Elements.FIRE, false, 35, 161, 15, 3, 0, 140, 0, 110, 0, 160, 0, 130, R.drawable.armor_robe_of_imminent_fires));
            ...
            armorList.add(createArmor(R.string.vest_of_blessed_glory, Elements.LIGHT, false, 36, 165, 15, 3, 2, 105, 170, 0, 100, 0, 130, 160, R.drawable.armor_vest_of_blessed_glory));
            armorList.add(createArmor(R.string.desert_rogue_suit, Elements.NEUTRAL, true, 50, 170, 10, 6, 3, 70, 0, 0, 130, 130, 0, 160, R.drawable.armor_desert_rogue_suit));
            ...
            armorList.add(createArmor(R.string.interrogator, Elements.WATER, false, 51, 234, 15, 0, 0, 120, 0, 0, 0, 160, 130, 150, R.drawable.armor_interrogator));
            armorList.add(createArmor(R.string.protector_of_the_oracle, Elements.EARTH, false, 51, 234, 15, -1, 0, 120, 0, 100, 0, 0, 160, 90, R.drawable.armor_protector_of_the_oracle));
            ...
            ringList.add(createRing(R.string.nenya, Elements.WATER, 0, 0, 4, 2, 50, 0, 0, 40, 0, 0, 50, R.drawable.ring_nenya));
            ...
            ringList.add(createRing(R.string.shaman_ring, Elements.NEUTRAL, 0, 0, 2, 2, 20, 0, 0, 0, 0, 0, 0, R.drawable.ring_shaman_narya_ring));
            ringList.add(createRing(R.string.spellmasters_ring, Elements.FIRE, 0, 0, 4, 2, 70, 0, 60, 0, 40, 0, 0, R.drawable.ring_spellmasters_ring));
            ...
            ringList.add(createRing(R.string.pirouette_pointe, Elements.NEUTRAL, 10, 0, 5, 7, 40, 0, 0, 0, 0, 0, 0, R.drawable.ring_pirouette_pointe));
            ...
            ringList.add(createRing(R.string.steelblow_ring, Elements.AIR, 20, 0, 12, 3, 40, 50, 0, 30, 50, 0, 0, R.drawable.ring_steelblow_ring));
            ...
            ringList.add(createRing(R.string.whisper_of_light, Elements.LIGHT, 40, 0, 5, 3, 100, 90, 90, 0, 0, 120, 0, R.drawable.ring_whisper_of_light));
            ...
            swordList.add(createWeapon(R.string.bunny_sword, WeaponTypes.SWORD, Elements.EARTH, 49, 49, 0, 0, 0, 20, R.drawable.sword_bunny_sword));
            ...
            daggerList.add(createWeapon(R.string.poisoned_dart, WeaponTypes.DAGGER, Elements.NEUTRAL, 15, 72, 16, 0, 20, 4, R.drawable.dagger_poisoned_dart));
            ...
            daggerList.add(createWeapon(R.string.gorgon_dagger, WeaponTypes.DAGGER, Elements.EARTH, 24, 98, 13, 30, 15, 2, R.drawable.dagger_gorgon_dagger));
            daggerList.add(createWeapon(R.string.ifrits_dagger, WeaponTypes.DAGGER, Elements.FIRE, 22, 101, 15, 0, 20, 2, R.drawable.dagger_ifrits_dagger));
            ...
            daggerList.add(createWeapon(R.string.ice_dagger, WeaponTypes.DAGGER, Elements.WATER, 40, 184, 15, 0, 15, 3, R.drawable.dagger_ice_dagger));
            daggerList.add(createWeapon(R.string.cthulhu_dagger, WeaponTypes.DAGGER, Elements.DARKNESS, 44, 202, 15, 20, 20, 3, R.drawable.dagger_cthulhu_dagger));
            daggerList.add(createWeapon(R.string.survivors_double_dagger, WeaponTypes.DAGGER, Elements.NEUTRAL, 44, 202, 15, 0, 15, 5, R.drawable.dagger_survivors_double_dagger));
            daggerList.add(createWeapon(R.string.venomous_dagger, WeaponTypes.DAGGER, Elements.NEUTRAL, 44, 202, 15, 10, 18, 2, R.drawable.dagger_venomous_dagger));
            ...
            daggerList.add(createWeapon(R.string.sapphire_pawns_dagger, WeaponTypes.DAGGER, Elements.NEUTRAL, 45, 207, 15, 0, 20, 0, R.drawable.dagger_sapphire_pawns_dagger));
            daggerList.add(createWeapon(R.string.dual_dragon_fang, WeaponTypes.DAGGER, Elements.NEUTRAL, 48, 220, 15, 0, 15, 5, R.drawable.dagger_dual_dragon_fang));
            daggerList.add(createWeapon(R.string.abyssal_dual_blade, WeaponTypes.DAGGER, Elements.WATER, 50, 230, 15, 0, 15, 5, R.drawable.dagger_abyssal_dual_blade));
            daggerList.add(createWeapon(R.string.toxic_dual_dagger, WeaponTypes.DAGGER, Elements.NEUTRAL, 50, 230, 15, 0, 15, 5, R.drawable.dagger_toxic_dual_dagger));
            ...
            daggerList.add(createWeapon(R.string.malicious_quickblade, WeaponTypes.DAGGER, Elements.NEUTRAL, 52, 239, 15, 0, 20, 5, R.drawable.dagger_malicious_quickblade));
