...
public class AchievementsAdapter extends RecyclerView.Adapter<AchievementsAdapter.AchievementViewHolder> {
    ...
    private List<Achievement> originalList;
    private List<Achievement> filteredList;

    public AchievementsAdapter(List<Achievement> achievements) {
        this.originalList = achievements;
        this.filteredList = new ArrayList<>(achievements);
    }
    ...
    public void filter(String text) {
        ...
        if (text == null || text.trim().isEmpty()) {
            ...
            for (Achievement a : originalList) {
                ...
                boolean matchesNumber =
                        String.valueOf(a.getOriginalIndex()).contains(query);

                if (matchesName || matchesDescription || matchesNumber) {
                    filteredList.add(a);
                }
            }
        }
    ...
    public void onBindViewHolder(@NonNull AchievementViewHolder holder, int position) {
        Achievement achievement = filteredList.get(position);
        holder.achievementNumberTextView.setText(
                String.valueOf(achievement.getOriginalIndex())
        );
