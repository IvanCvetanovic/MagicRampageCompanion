...
public class ItemData {
    ...
    public static void init(Context context) {
        ...
        daggerList.add(new Weapon(str(context, R.string.dawnfang), WeaponTypes.DAGGER, Elements.LIGHT, 54, 248, 15, -30, 25, 0, R.drawable.dagger_dawnfang, 380, 3, true, false, false, false, 0, 0, 4000, 2400, 0, 1, List.of(str(context, R.string.shop))));
        ...
        staffList.add(new Weapon(str(context, R.string.arcane_rod_staff), WeaponTypes.STAFF, Elements.AIR, 65, 299, 15, -20, 4, 5, R.drawable.staff_arcane_rod_staff, 650, 5, true, true, false, true, 0, 0, 2900, 2340, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        staffList.add(new Weapon(str(context, R.string.all_seeing_staff), WeaponTypes.STAFF, Elements.DARKNESS, 135, 621, 15, -30, 4, 5, R.drawable.staff_all_seeing_staff, 600, 8, false, true, false, false, 0, 0, 8200, 4920, 27777, 55555, List.of(str(context, R.string.shop))));
