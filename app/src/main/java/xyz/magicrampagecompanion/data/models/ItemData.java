...
public class ItemData {
    ...
    public static void init(Context context) {
        ...
        staffList.add(new Weapon(str(context, R.string.arcane_rod_staff), WeaponTypes.STAFF, Elements.DARKNESS, 65, 299, 15, -20, 4, 5, R.drawable.staff_arcane_rod_staff, 650, 5, true, true, false, true, 0, 0, 2900, 2340, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
