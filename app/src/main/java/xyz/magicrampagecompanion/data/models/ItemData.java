...
public class ItemData {
    ...
    public static void init(Context context) {
        ...
        hammerList.add(new Weapon(str(context, R.string.all_seeing_hammer), WeaponTypes.HAMMER, Elements.DARKNESS, 66, 303, 15, 40, 0, 0, R.drawable.hammer_all_seeing_hammer, 700, 1, true, true, false, false, 0, 0, 6000, 3601, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
