...
public class ItemData {
    ...
    public static int SkillTreeAxeBonus    = 48;
    ...
    public static int pepperBrewArmorBonus              = 21;
    public static int starlightSupertonicDamageBonus   = 70;
    public static int tonicOfInvulnerabilityArmorBonus = 21;
    ...
    public static void init(Context context) {
        ...
        swordList.add(new Weapon(str(context, R.string.bunny_sword), WeaponTypes.SWORD, Elements.EARTH, 49, 49, 1, 0, 0, 20, R.drawable.sword_bunny_sword, 500, 1, false, false, false, false, 0, 0, 2500, 1500, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        swordList.add(new Weapon(str(context, R.string.light_piercer), WeaponTypes.SWORD, Elements.LIGHT, 90, 414, 15, 25, 7, 5, R.drawable.sword_light_piercer, 550, 1, false, true, false, false, 874000, 449000, 3300, 1981, 33333, 66666, List.of(str(context, R.string.shop))));
        swordList.add(new Weapon(str(context, R.string.air_piercer), WeaponTypes.SWORD, Elements.AIR, 77, 354, 15, 0, 10, 3, R.drawable.sword_air_piercer, 520, 1, false, false, false, false, 1750000, 900000, 0, 0, 194444, 388888, List.of(str(context, R.string.shop))));
        ...
        swordList.add(new Weapon(str(context, R.string.frost_heart), WeaponTypes.SWORD, Elements.DARKNESS, 88, 404, 15, 30, 3, 2, R.drawable.sword_frostheart, 500, 1, false, false, false, true, 0, 0, 4400, 2640, 27777, 55555, List.of(str(context, R.string.shop))));
        ...
        swordList.add(new Weapon(str(context, R.string.bunny_claymore), WeaponTypes.SWORD, Elements.NEUTRAL, 88, 404, 15, 30, 6, 10, R.drawable.sword_bunny_claymore, 600, 0, true, false, false, false, 0, 0, 2500, 1500, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        swordList.add(new Weapon(str(context, R.string.haunted_slicer), WeaponTypes.SWORD, Elements.DARKNESS, 100, 460, 15, 20, 5, 3, R.drawable.sword_haunted_slicer, 500, 2, false, true, false, false, 0, 0, 4500, 2700, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest), str(context, R.string.shop))));
        swordList.add(new Weapon(str(context, R.string.oasis_blade), WeaponTypes.SWORD, Elements.EARTH, 110, 506, 15, 30, 5, 6, R.drawable.sword_oasis_blade, 550, 0, true, true, false, false, 0, 0, 4000, 2400, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        daggerList.add(new Weapon(str(context, R.string.poisoned_dagger), WeaponTypes.DAGGER, Elements.EARTH, 10, 48, 16, 0, 20, 4, R.drawable.dagger_poisoned_dagger, 400, 0, true, false, true, false, 4800, 2400, 0, 0, 533, 1066, List.of(str(context, R.string.chapter_one_random_drop), str(context, R.string.chapter_two_random_drop), str(context, R.string.chapter_three_random_drop), str(context, R.string.shop))));
        daggerList.add(new Weapon(str(context, R.string.poisoned_dart), WeaponTypes.DAGGER, Elements.NEUTRAL, 15, 72, 16, 0, 20, 4, R.drawable.dagger_poisoned_dart, 300, 0, true, false, true, false, 5, 2, 0, 0, 0, 1, List.of(str(context, R.string.achievement))));
        ...
        daggerList.add(new Weapon(str(context, R.string.bunnyhop_dagger), WeaponTypes.DAGGER, Elements.NEUTRAL, 39, 179, 15, 0, 20, 18, R.drawable.dagger_bunnyhop_dagger, 550, 1, true, false, false, false, 0, 0, 2000, 1200, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        daggerList.add(new Weapon(str(context, R.string.ice_dagger), WeaponTypes.DAGGER, Elements.WATER, 40, 184, 15, 0, 15, 3, R.drawable.dagger_ice_dagger, 360, 1, true, false, false, true, 0, 0, 3300, 1981, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        daggerList.add(new Weapon(str(context, R.string.venomous_dagger), WeaponTypes.DAGGER, Elements.NEUTRAL, 46, 211, 15, 0, 18, 2, R.drawable.dagger_venomous_dagger, 400, 1, true, false, true, false, 265000, 136000, 3000, 1801, 36111, 72222, List.of(str(context, R.string.shop))));
        daggerList.add(new Weapon(str(context, R.string.dragon_tooth_dagger), WeaponTypes.DAGGER, Elements.NEUTRAL, 48, 220, 15, -40, 25, 10, R.drawable.dagger_dragon_tooth_dagger, 360, 1, true, false, false, false, 600000, 308000, 0, 0, 66666, 133333, List.of(str(context, R.string.shop), str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        daggerList.add(new Weapon(str(context, R.string.scorpion_fang), WeaponTypes.DAGGER, Elements.AIR, 50, 230, 15, -20, 15, 0, R.drawable.dagger_scorpion_fang, 420, 2, true, false, true, false, 0, 0, 4000, 2400, 0, 1, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        daggerList.add(new Weapon(str(context, R.string.cthulhu_dagger), WeaponTypes.DAGGER, Elements.DARKNESS, 52, 239, 15, 0, 20, 5, R.drawable.dagger_cthulhu_dagger, 400, 2, true, false, true, false, 0, 0, 3500, 2100, 27777, 55555, List.of(str(context, R.string.shop), str(context, R.string.weekly_dungeon_golden_chest))));
        daggerList.add(new Weapon(str(context, R.string.malicious_quickblade), WeaponTypes.DAGGER, Elements.NEUTRAL, 52, 239, 15, -20, 20, 5, R.drawable.dagger_malicious_quickblade, 450, 1, true, false, true, false, 0, 0, 3500, 2100, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        daggerList.add(new Weapon(str(context, R.string.all_seeing_cleaver), WeaponTypes.DAGGER, Elements.NEUTRAL, 52, 239, 15, -15, 25, 3, R.drawable.dagger_all_seeing_cleaver, 360, 1, true, false, false, false, 0, 0, 6000, 3601, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        daggerList.add(new Weapon(str(context, R.string.dawnfang), WeaponTypes.DAGGER, Elements.LIGHT, 54, 248, 15, -30, 25, 0, R.drawable.dagger_dawnfang, 380, 3, true, false, false, false, 0, 0, 4000, 2400, 0, 1, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        daggerList.add(new Weapon(str(context, R.string.steelblow_shuriken), WeaponTypes.DAGGER, Elements.AIR, 70, 322, 15, -20, 28, 0, R.drawable.shuriken_steelblow_shuriken, 320, 1, false, false, false, false, 0, 0, 4000, 2400, 63777, 127555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        daggerList.add(new Weapon(str(context, R.string.ifrits_shuriken), WeaponTypes.DAGGER, Elements.FIRE, 74, 340, 15, -20, 15, 3, R.drawable.shuriken_ifrits_shuriken, 340, 0, true, false, true, false, 198000, 101000, 4000, 2400, 22000, 44000, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        daggerList.add(new Weapon(str(context, R.string.undines_shuriken), WeaponTypes.DAGGER, Elements.WATER, 76, 349, 15, -20, 15, 3, R.drawable.shuriken_undines_shuriken, 360, 0, true, false, false, true, 265000, 136000, 4000, 2400, 29444, 58888, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        daggerList.add(new Weapon(str(context, R.string.gayan_shuriken), WeaponTypes.DAGGER, Elements.EARTH, 80, 368, 15, -10, 15, 3, R.drawable.shuriken_gayan_shuriken, 340, 0, true, false, false, false, 210000, 108000, 4000, 2400, 23333, 46666, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        daggerList.add(new Weapon(str(context, R.string.shooting_star_shuriken), WeaponTypes.DAGGER, Elements.LIGHT, 84, 386, 15, -20, 18, 0, R.drawable.shuriken_shooting_star_shuriken, 360, 1, true, false, false, false, 820000, 421000, 4000, 2400, 91111, 182222, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        daggerList.add(new Weapon(str(context, R.string.black_shuriken), WeaponTypes.DAGGER, Elements.DARKNESS, 90, 414, 15, -45, 18, 6, R.drawable.shuriken_black_shuriken, 350, 1, false, false, true, false, 0, 0, 4000, 2400, 114444, 228888, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        hammerList.add(new Weapon(str(context, R.string.toxic_hammer), WeaponTypes.HAMMER, Elements.NEUTRAL, 48, 220, 15, 70, 0, 0, R.drawable.hammer_toxic_hammer, 750, 1, true, true, true, false, 0, 0, 2600, 1561, 27777, 55555, List.of(str(context, R.string.shop))));
        ...
        hammerList.add(new Weapon(str(context, R.string.war_forged_smasher), WeaponTypes.HAMMER, Elements.FIRE, 65, 299, 15, 70, 0, 0, R.drawable.hammer_war_forged_smasher, 700, 1, true, true, false, false, 0, 0, 4200, 2520, 27777, 55555, List.of(str(context, R.string.shop))));
        hammerList.add(new Weapon(str(context, R.string.enlightened_hammer), WeaponTypes.HAMMER, Elements.LIGHT, 65, 299, 15, 60, 0, 0, R.drawable.hammer_enlightened_hammer, 650, 2, true, true, false, false, 0, 0, 4200, 2520, 27777, 55555, List.of(str(context, R.string.shop))));
        hammerList.add(new Weapon(str(context, R.string.root_of_judgement), WeaponTypes.HAMMER, Elements.EARTH, 66, 303, 15, 70, 0, 4, R.drawable.hammer_root_of_judgement, 700, 1, true, true, false, false, 0, 0, 7500, 4500, 16666, 33333, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        hammerList.add(new Weapon(str(context, R.string.all_seeing_hammer), WeaponTypes.HAMMER, Elements.DARKNESS, 66, 303, 15, 55, 0, 0, R.drawable.hammer_all_seeing_hammer, 700, 1, true, true, false, false, 0, 0, 6000, 3601, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        hammerList.add(new Weapon(str(context, R.string.eye_of_the_rift), WeaponTypes.HAMMER, Elements.DARKNESS, 68, 312, 15, 70, 0, 0, R.drawable.hammer_eye_of_the_rift, 700, 1, true, true, false, false, 0, 0, 7500, 4500, 16666, 33333, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        staffList.add(new Weapon(str(context, R.string.the_testament_of_ifrit), WeaponTypes.STAFF, Elements.FIRE, 38, 174, 15, 0, 7, 0, R.drawable.grimoire_the_testament_of_ifrit, 400, 4, true, false, false, false, 0, 0, 3700, 2220, 27777, 55555, List.of(str(context, R.string.shop))));
        ...
        staffList.add(new Weapon(str(context, R.string.the_ancient_codices), WeaponTypes.STAFF, Elements.NEUTRAL, 50, 230, 15, 0, 4, 6, R.drawable.grimoire_the_ancient_codices, 450, 0, false, false, false, false, 0, 0, 5500, 3301, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        staffList.add(new Weapon(str(context, R.string.the_daemon_codices), WeaponTypes.STAFF, Elements.DARKNESS, 54, 248, 15, -20, 0, 7, R.drawable.grimoire_the_daemon_codices, 400, 2, false, false, false, false, 0, 0, 4000, 2400, 27777, 55555, List.of(str(context, R.string.shop))));
        ...
        staffList.add(new Weapon(str(context, R.string.arcane_rod_staff), WeaponTypes.STAFF, Elements.AIR, 65, 299, 15, -20, 4, 5, R.drawable.staff_arcane_rod_staff, 650, 5, true, true, false, true, 0, 0, 3900, 2340, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        staffList.add(new Weapon(str(context, R.string.tome_of_the_sands), WeaponTypes.STAFF, Elements.AIR, 66, 303, 15, -50, 10, 0, R.drawable.grimoire_tome_of_the_sands, 450, 2, true, false, false, false, 0, 0, 3900, 2340, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        staffList.add(new Weapon(str(context, R.string.staff_shooting_star_staff), WeaponTypes.STAFF, Elements.LIGHT, 68, 312, 15, -10, 0, 9, R.drawable.staff_shooting_star_staff, 650, 0, true, false, false, true, 0, 0, 4500, 2700, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        staffList.add(new Weapon(str(context, R.string.legacy_of_the_oracle), WeaponTypes.STAFF, Elements.EARTH, 90, 414, 15, 15, 3, 7, R.drawable.staff_legacy_of_the_oracle, 600, 1, true, true, false, false, 0, 0, 4000, 2400, 27777, 55555, List.of(str(context, R.string.shop), str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        staffList.add(new Weapon(str(context, R.string.crowned_dragonhead), WeaponTypes.STAFF, Elements.FIRE, 102, 469, 15, -10, 4, 4, R.drawable.staff_crowned_dragonhead, 550, 1, true, true, false, false, 0, 0, 7500, 4500, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        staffList.add(new Weapon(str(context, R.string.voidcaller_staff), WeaponTypes.STAFF, Elements.DARKNESS, 135, 621, 15, -30, 4, 5, R.drawable.staff_voidcaller_staff, 600, 1, false, false, false, false, 0, 0, 5300, 3181, 27777, 55555, List.of(str(context, R.string.shop))));
        staffList.add(new Weapon(str(context, R.string.all_seeing_staff), WeaponTypes.STAFF, Elements.DARKNESS, 135, 621, 15, -30, 4, 5, R.drawable.staff_all_seeing_staff, 600, 8, false, true, false, false, 0, 0, 8200, 4920, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));

        // Spears
        spearList.add(new Weapon(str(context, R.string.bunny_spear), WeaponTypes.SPEAR, Elements.NEUTRAL, 35, 161, 15, -10, 8, 20, R.drawable.spear_bunny_spear, 550, 3, false, true, false, false, 0, 0, 2500, 1500, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        spearList.add(new Weapon(str(context, R.string.poisoned_spear), WeaponTypes.SPEAR, Elements.EARTH, 58, 266, 15, 0, 10, 0, R.drawable.spear_poisoned_spear, 500, 4, true, true, true, false, 600000, 308000, 0, 0, 66666, 133333, List.of(str(context, R.string.shop))));
        spearList.add(new Weapon(str(context, R.string.gorgon_spear), WeaponTypes.SPEAR, Elements.NEUTRAL, 60, 276, 15, 0, 10, 0, R.drawable.spear_gorgon_spear, 650, 4, true, true, true, false, 0, 0, 3600, 2160, 27777, 55555, List.of(str(context, R.string.shop))));
        ...
        spearList.add(new Weapon(str(context, R.string.vindictive_piercer), WeaponTypes.SPEAR, Elements.AIR, 75, 345, 15, 0, 6, 2, R.drawable.spear_vindictive_piercer, 650, 5, false, true, false, false, 0, 0, 3600, 2160, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        axeList.add(new Weapon(str(context, R.string.eggscellent_axe), WeaponTypes.AXE, Elements.NEUTRAL, 52, 239, 15, 30, 3, 17, R.drawable.axe_eggscellent_axe, 500, 0, true, true, false, false, 0, 0, 2500, 1500, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        axeList.add(new Weapon(str(context, R.string.windpearl_axe), WeaponTypes.AXE, Elements.AIR, 75, 345, 15, 20, 8, 1, R.drawable.axe_windpearl_axe, 600, 1, true, true, false, false, 0, 0, 3800, 2280, 27777, 55555, List.of(str(context, R.string.shop))));
        ...
        axeList.add(new Weapon(str(context, R.string.all_seeing_axe), WeaponTypes.AXE, Elements.DARKNESS, 105, 483, 15, 40, 3, 3, R.drawable.axe_all_seeing_axe, 600, 1, true, true, false, false, 0, 0, 6000, 3601, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        armorList.add(new Armor(str(context, R.string.storm), Elements.AIR, false, 20, 92, 15, 7, 4, 130, 0, 170, 0, 170, 0, 0, R.drawable.armor_storm, 0, 0, 4400, 2640, 27777, 55555, List.of(str(context, R.string.shop))));
        ...
        armorList.add(new Armor(str(context, R.string.wind_witch_suit), Elements.AIR, false, 21, 96, 15, 6, 4, 140, 100, 0, 140, 0, 0, 140, R.drawable.armor_wind_witch_suit, 0, 0, 4400, 2640, 27777, 55555, List.of(str(context, R.string.shop), str(context, R.string.weekly_dungeon_golden_chest))));
        armorList.add(new Armor(str(context, R.string.tunic_of_ending_nights), Elements.NEUTRAL, true, 21, 96, 15, 3, 2, 150, 0, 140, 100, 0, 0, 0, R.drawable.armor_tunic_of_ending_nights, 0, 0, 4800, 2880, 27777, 55555, List.of(str(context, R.string.shop))));
        ...
        armorList.add(new Armor(str(context, R.string.tunic_of_frozen_voices), Elements.WATER, true, 25, 115, 15, 0, 0, 170, 0, 140, 90, 0, 0, 150, R.drawable.armor_tunic_of_frozen_voices, 0, 0, 4200, 2520, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        armorList.add(new Armor(str(context, R.string.death_stalker), Elements.DARKNESS, false, 26, 119, 15, 2, 0, 160, 0, 110, 140, 0, 0, 150, R.drawable.armor_death_stalker, 0, 0, 4400, 2640, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        armorList.add(new Armor(str(context, R.string.robe_of_eternal_fire), Elements.FIRE, false, 27, 124, 15, 4, 3, 180, 120, 0, 0, 50, 0, 120, R.drawable.armor_robe_of_eternal_fire, 0, 0, 4300, 2580, 27777, 55555, List.of(str(context, R.string.shop))));
        ...
        armorList.add(new Armor(str(context, R.string.robe_of_distant_visions), Elements.EARTH, false, 29, 133, 15, 4, 3, 170, 0, 130, 0, 0, 0, 160, R.drawable.armor_robe_of_distant_visions, 0, 0, 4400, 2640, 27777, 55555, List.of(str(context, R.string.shop), str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        armorList.add(new Armor(str(context, R.string.robe_of_imminent_fires), Elements.FIRE, false, 35, 161, 15, 3, 0, 140, 0, 110, 0, 190, 0, 130, R.drawable.armor_robe_of_imminent_fires, 0, 0, 4200, 2520, 27777, 55555, List.of(str(context, R.string.shop), str(context, R.string.weekly_dungeon_golden_chest))));
        armorList.add(new Armor(str(context, R.string.tunic_of_distant_ancestors), Elements.EARTH, false, 36, 165, 15, 3, 2, 130, 0, 0, 200, 170, 0, 0, R.drawable.armor_tunic_of_distant_ancestors, 0, 0, 4300, 2580, 27777, 55555, List.of(str(context, R.string.shop), str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        armorList.add(new Armor(str(context, R.string.easterminator), Elements.NEUTRAL, false, 40, 184, 15, 5, 18, 40, 50, 0, 50, 0, 50, 50, R.drawable.armor_easterminator, 0, 0, 3500, 2100, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        armorList.add(new Armor(str(context, R.string.time_patroller_suit), Elements.NEUTRAL, false, 56, 190, 10, 2, 2, 300, 0, 0, 0, 0, 0, 0, R.drawable.armor_time_patroller_suit, 5, 2, 0, 0, 0, 1, List.of(str(context, R.string.achievement))));
        ...
        armorList.add(new Armor(str(context, R.string.interrogator), Elements.WATER, false, 51, 234, 15, 0, 0, 110, 0, 0, 0, 120, 140, 160, R.drawable.armor_interrogator, 0, 0, 4200, 2520, 27777, 55555, List.of(str(context, R.string.shop))));
        ...
        armorList.add(new Armor(str(context, R.string.warden_of_demons), Elements.DARKNESS, false, 52, 239, 15, 0, 0, 80, 140, 0, 0, 140, 145, 0, R.drawable.armor_warden_of_demons, 0, 0, 4200, 2520, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        armorList.add(new Armor(str(context, R.string.destroyer_of_the_corrupted), Elements.LIGHT, false, 52, 239, 15, 0, 0, 80, 100, 0, 0, 140, 175, 0, R.drawable.armor_destroyer_of_the_corrupted, 0, 0, 4200, 2520, 27777, 55555, List.of(str(context, R.string.shop))));
        armorList.add(new Armor(str(context, R.string.vanquisher), Elements.AIR, false, 55, 253, 15, 0, 0, 70, 160, 0, 0, 0, 0, 170, R.drawable.armor_vanquisher, 0, 0, 4200, 2520, 27777, 55555, List.of(str(context, R.string.shop))));
        armorList.add(new Armor(str(context, R.string.cataclysmic_plate), Elements.FIRE, false, 56, 257, 15, -1, 0, 55, 140, 0, 0, 170, 220, 0, R.drawable.armor_cataclysmic_plate, 0, 0, 4200, 2520, 27777, 55555, List.of(str(context, R.string.shop))));
        ...
        ringList.add(new Ring(str(context, R.string.bloodforged_charm_earring), Elements.NEUTRAL, 10, 0, 0, 14, 110, 110, 0, 100, 0, 0, 0, R.drawable.ring_bloodforged_charm, 0, 0, 6500, 3901, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ringList.add(new Ring(str(context, R.string.moonbound_necklace), Elements.NEUTRAL, 10, 0, 0, 14, 110, 0, 0, 0, 110, 150, 0, R.drawable.ring_moonbound_necklace, 0, 0, 6500, 3901, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ringList.add(new Ring(str(context, R.string.skybreaker_band), Elements.NEUTRAL, 10, 0, 0, 14, 110, 0, 120, 0, 0, 0, 120, R.drawable.ring_skybreaker_band, 0, 0, 6500, 3901, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        ringList.add(new Ring(str(context, R.string.golden_guardian), Elements.NEUTRAL, 30, 0, 0, 0, 100, 0, 0, 0, 0, 130, 100, R.drawable.ring_golden_guardian, 0, 0, 3900, 2340, 27777, 55555, List.of(str(context, R.string.weekly_dungeon_golden_chest))));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_xmas_skeleton_red_warrior), 150, 30, 0, 150, 5.67, 31.93, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_xmas_skeleton_red_warrior));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_carnival_buffoon_purple_skeleton), 170, 40, 0, 20, 5.9, 31.93, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_carnival_buffoon_purple_skeleton));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_xmas_skeleton_red_mage), 170, 50, 0, 150, 5.67, 31.93, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_xmas_skeleton_red_warrior));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_armored_axe_skeleton), 300, 30, 0, 0, 5.4, 31.31, context.getString(R.string.waypoints), context.getString(R.string.stone_thrower), R.drawable.enemy_jumping_fire_skeleton));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_water_vampire), 340, 45, 0, 20, 6.18, 32.1, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_water_vampire));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_carnival_buffoon_green_skeleton), 600, 40, 0, 20, 5.9, 32.96, context.getString(R.string.waypoints), context.getString(R.string.stone_thrower), R.drawable.enemy_carnival_buffoon_green_skeleton));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_ice_skeleton), 600, 100, 0, 150, 5.67, 32.96, context.getString(R.string.waypoints), context.getString(R.string.stone_thrower), R.drawable.enemy_ice_skeleton));
        enemyList.add(new Enemy(str(context, R.string.enemy_ifrits_disciple), 600, 30, 0, 0, 6.24, 31.2, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_ifrits_disciple));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_xmas_skeleton_blue_helmet_ice), 600, 100, 0, 150, 5.67, 32.96, context.getString(R.string.waypoints), context.getString(R.string.stone_thrower), R.drawable.enemy_xmas_skeleton_blue_helmet_ice));
        enemyList.add(new Enemy(str(context, R.string.enemy_xmas_skeleton_blue_ice), 600, 100, 0, 150, 5.67, 32.96, context.getString(R.string.waypoints), context.getString(R.string.stone_thrower), R.drawable.enemy_xmas_skeleton_blue_helmet_ice));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_ice_skeleton_elite), 800, 150, 0, 250, 5.67, 32.96, context.getString(R.string.waypoints), context.getString(R.string.stone_thrower), R.drawable.enemy_ice_skeleton_elite));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_shaman_fire), 850, 60, 0, 40, 6.24, 32.14, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_shaman_fire));
        enemyList.add(new Enemy(str(context, R.string.enemy_shaman_nature), 850, 40, 0, 40, 6.78, 31.93, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_shaman_nature));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_rat_fire_mage), 1000, 80, 0, 0, 5.45, 31.31, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_rat_fire_mage));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_xmas_skeleton_blue_mage), 1000, 40, 0, 150, 5.67, 30.9, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_xmas_skeleton_blue_mage));
        enemyList.add(new Enemy(str(context, R.string.enemy_rat_lancer), 1100, 60, 0, 0, 5.72, 38.62, context.getString(R.string.waypoints), context.getString(R.string.stone_thrower), R.drawable.enemy_rat_lancer));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_rat_rogue), 1500, 30, 0, 40, 8.48, 38.48, context.getString(R.string.waypoints), context.getString(R.string.stone_thrower), R.drawable.enemy_rat_rogue_prisoner));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_pumpkin_skeleton), 2000, 80, 0, 50, 7.14, 36.72, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_pumpkin_skeleton));
        enemyList.add(new Enemy(str(context, R.string.enemy_pumpkin_water_skeleton), 2000, 80, 0, 50, 7.14, 36.72, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_pumpkin_water_skeleton));
        enemyList.add(new Enemy(str(context, R.string.enemy_rat_zombie_knife_guard_b), 2000, 51, 0, 25, 6.24, 40.71, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_rat_zombie_knife_guard));
        enemyList.add(new Enemy(str(context, R.string.enemy_rat_zombie_knife_guard), 2000, 51, 0, 25, 6.24, 40.71, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_rat_zombie_knife_guard));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_ice_skeleton_wdg), 3000, 100, 0, 150, 5.67, 32.96, context.getString(R.string.waypoints), context.getString(R.string.stone_thrower), R.drawable.enemy_ice_skeleton));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_xmas_green_bear_small), 3000, 50, 0, 0, 12.0, 39.52, context.getString(R.string.waypoints), context.getString(R.string.stone_thrower), R.drawable.enemy_xmas_green_bear));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_ice_skeleton_elite_wdg), 4000, 150, 0, 250, 5.67, 32.96, context.getString(R.string.waypoints), context.getString(R.string.stone_thrower), R.drawable.enemy_ice_skeleton_elite));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_junina_skeleton_knife_guard), 4000, 51, 0, 0, 7.2, 30.68, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_junina_skeleton_poison_thrower));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_rat_warrior), 4000, 70, 0, 0, 6.18, 40.17, context.getString(R.string.waypoints), context.getString(R.string.stone_thrower), R.drawable.enemy_rat_warrior));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_xmas_purple_bear), 4000, 100, 0, 0, 5.67, 36.05, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_xmas_purple_bear));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_xmas_skeleton_red_mage_elite), 7500, 80, 0, 150, 5.73, 31.93, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_xmas_skeleton_red_warrior));
        enemyList.add(new Enemy(str(context, R.string.enemy_carnival_rat_buffoon_green), 8000, 100, 0, 25, 5.46, 41.38, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_carnival_rat_buffoon_green));
        enemyList.add(new Enemy(str(context, R.string.enemy_carnival_rat_buffoon_purple), 8000, 100, 0, 25, 5.46, 41.38, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_carnival_rat_buffoon_purple));
        enemyList.add(new Enemy(str(context, R.string.enemy_rat_zombie_knife_guard_elite), 8000, 100, 0, 25, 6.24, 41.78, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_rat_zombie_knife_guard_elite));
        enemyList.add(new Enemy(str(context, R.string.enemy_tanker_elite_matryoshka), 8000, 70, 0, 0, 5.25, 25.75, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_harmless_tanker));
        enemyList.add(new Enemy(str(context, R.string.enemy_guard_tanker_elite), 9000, 70, 0, 0, 5.25, 25.75, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_harmless_tanker));
        enemyList.add(new Enemy(str(context, R.string.enemy_shaman_fire_elite), 9000, 60, 0, 80, 6.24, 32.14, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_shaman_fire));
        enemyList.add(new Enemy(str(context, R.string.enemy_shaman_nature_elite), 9000, 50, 0, 80, 9.04, 35.02, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_shaman_nature));
        enemyList.add(new Enemy(str(context, R.string.enemy_xmas_skeleton_red_warrior_elite), 9000, 70, 0, 150, 5.51, 26.52, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_xmas_skeleton_red_warrior));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_mummy_gold_cosmos), 9500, 70, 0, 0, 5.67, 31.93, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_mummy));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_xmas_fire_bear_elite), 10000, 30, 0, 0, 5.82, 32.24, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_xmas_fire_bear));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_xmas_skeleton_blue_tanker), 15000, 190, 0, 150, 5.67, 33.99, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_xmas_skeleton_blue_helmet_ice));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_alien), 9999999, 0, 0, 36, 7.42, 36.75, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_alien));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_priest_minion), 999999999, 28, 0, 0, 8.48, 35.31, "", "", R.drawable.enemy_priest_minion));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_time_patroller_dungeon40), 999999999, 6, 0, 36, 7.42, 36.75, context.getString(R.string.waypoints), context.getString(R.string.knife_thrower), R.drawable.enemy_time_patroller_boss));
        ...
        enemyList.add(new Enemy(str(context, R.string.enemy_beholder_witch), 999999999, 60, 0, 0, 5.2, 1.04, context.getString(R.string.waypoints), context.getString(R.string.stone_thrower), R.drawable.enemy_beholder_witch));
        enemyList.add(new Enemy(str(context, R.string.enemy_beholder), 999999999, 60, 0, 0, 5.2, 1.04, context.getString(R.string.waypoints), context.getString(R.string.stone_thrower), R.drawable.enemy_beholder));
...
// 9 & 10 colored
        ...
        mageSkins.add(new SkinItem(context.getString(R.string.skin_mage17) + " A", R.drawable.skin_mage17a));
