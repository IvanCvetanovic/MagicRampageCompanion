...
public class SurvivalDungeon1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_survival_dungeon1);
    ...
    // Same helper used on other screens
    private void applySystemInsets(View scrollViewOrNull, View contentRootOrNull) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(root, (v, insets) -> {
            ...
            // Keep header below status bar/cutout
