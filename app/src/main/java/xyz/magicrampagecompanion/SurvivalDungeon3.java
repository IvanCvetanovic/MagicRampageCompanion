...
public class SurvivalDungeon3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_survival_dungeon3);

        // Apply system bar insets (status bar / cutout / nav bar)
    ...
    // Edge-to-edge helper (same pattern as your other screens)
