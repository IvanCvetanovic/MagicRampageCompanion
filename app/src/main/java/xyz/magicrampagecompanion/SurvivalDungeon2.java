...
public class SurvivalDungeon2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_survival_dungeon2);

        // Apply safe-area (status bar / cutout / nav bar) insets
    ...
    // Same helper as in MainActivity
    private void applySystemInsets(View scrollViewOrNull, View contentRootOrNull) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(root, (v, insets) -> {
            ...
            // Move content below status bar / camera cutout
            ...
            // Keep bottom content above gesture nav bar
