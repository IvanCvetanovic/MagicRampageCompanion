...
public class AchievementsPage extends AppCompatActivity {
    ...
    private void populateAchievements() {
        ...
        achievements.add(new Achievement("Head shot!", "Hit an enemy with a head shot.", Arrays.asList("4000/16000")));
        ...
        achievements.add(new Achievement("Save that Dude!", "Keep That Dude from being attacked in Chapter 1 Dungeon level 2.", Arrays.asList("8000/32000", "", "", "+1")));
        achievements.add(new Achievement("Mr. MacGyver", "Access the secret area in Chapter 1 Dungeon Bonus level 3.", Arrays.asList()));
        achievements.add(new Achievement("The Bone Collector", "Defeat a skeleton.", Arrays.asList("4000/16000")));
        achievements.add(new Achievement("Class consciousness", "Learn and perform the special skill of your class in Chapter 1 Dungeon level 6.", Arrays.asList("8000/32000")));
        achievements.add(new Achievement("Spider killer", "Kill a spider.", Arrays.asList("4000/16000")));
        achievements.add(new Achievement("Keep That Dude alive!", "Help That Dude in Chapter 1 Dungeo level 8 and keep him alive.", Arrays.asList("12000/48000", "", "", "+1")));
        achievements.add(new Achievement("That Dude's story", "Listen to what That Dude has to say in CHapter 1 Dungeon level 8 (if he survived Chapter1 Dungeon level 2).", Arrays.asList("8000/32000", "", "", "+1")));
        achievements.add(new Achievement("Flawless victory!", "Get a star be replaying a level without taking any damage.", Arrays.asList("2500/10000")));
        ...
        achievements.add(new Achievement("In your honor, have a toast!", "Buy a drink for another player in the Tavern.", Arrays.asList("", "250/750")));
        achievements.add(new Achievement("Dirty-faced Rookie", "Finish a Solo Dungeon in the Competitive Mode.", Arrays.asList("5000/20000")));
        achievements.add(new Achievement("Bring it on!", "Start a match against another player in the Competitive Mode.", Arrays.asList("8000/32000")));
        achievements.add(new Achievement("I came, I saw, I conquered", "Win a match against another player in the Competitive Mode.", Arrays.asList("20000/80000")));
        ...
        achievements.add(new Achievement("Challenge Accepted", "Finish a Challenge from the Weekly Challenge Portal.", Arrays.asList("12500/50000")));
        achievements.add(new Achievement("It's Amazing!", "Beat the Amazing Score Goal in the weekly Dungeons. You need to beat Ordinary and Super goals first.", Arrays.asList("", "500/1500")));
        achievements.add(new Achievement("Friends will be friends", "Add a friend in the Competitive Mode.", Arrays.asList("30000/120000")));
        achievements.add(new Achievement("Friendly fire", "Challenge a friend in the Competitive Mode.", Arrays.asList("50000/200000")));
        achievements.add(new Achievement("R for Revenge", "Win a revenge match in the Competitive Mode.", Arrays.asList("", "", "Obsidian Spear")));
        achievements.add(new Achievement("50 kills", "Kill 50 enemies in Survival mode.", Arrays.asList("16000/64000")));
        achievements.add(new Achievement("100 kills", "Kill 100 enemies in Survival Mode.", Arrays.asList("40000/160000")));
        achievements.add(new Achievement("Unlock all survival levels", "Unlock every survival level by reaching all minimum scores.", Arrays.asList("30000/120000", "", "", "+1")));
        ...
        achievements.add(new Achievement("The Untold Story", "Let that Dude tell you The Untold Story in Chapter 2 Dungeon level 4.", Arrays.asList("10000/40000", "", "", "+1")));
        achievements.add(new Achievement("That Dude must live!", "Keep That Dude alive until the end of the level.", Arrays.asList("16000/64000", "", "", "+1")));
        ...
        achievements.add(new Achievement("Runeforge", "Upgrade an item.", Arrays.asList("8000/32000")));
        achievements.add(new Achievement("Ride the Wind", "Reach the last chest in Chapter 2 Dungeon level 7.", Arrays.asList("14000/56000")));
        achievements.add(new Achievement("Ghostbusters", "Defeat a ghost in Chapter 2 Dungeon level 7.", Arrays.asList("10000/40000")));
        ...
        achievements.add(new Achievement("The Untold Story 2", "Hear what The Captain has to say about Portals and giant winged creatures in Chapter 2 Dungeon level 9.", Arrays.asList("10000/40000")));
        ...
        achievements.add(new Achievement("I saw a giant", "Kill a giant.", Arrays.asList("10000/40000")));
        ...
        achievements.add(new Achievement("Skilled but dirty-faced", "Learn three skills from the Skill Tree.", Arrays.asList("", "250/750")));
        achievements.add(new Achievement("The super skill", "Learn one of the Super Skills from the Skill Tree..", Arrays.asList("", "350/1050")));
        ...
        achievements.add(new Achievement("Bronze Beast", "Raise your Rank up to Bronze in the Competitive Mode.", Arrays.asList("", "150/450")));
        achievements.add(new Achievement("Silver Soldier", "Raise your Rank up to Gold in the Competituve Mode.", Arrays.asList("", "250/750", "", "+1")));
        achievements.add(new Achievement("Going Gold!", "Raise your Rank up to Gold in the Competitive Mode.", Arrays.asList("", "300/900", "", "+1")));
        achievements.add(new Achievement("Pure Platinum!", "Raise your Rank up to Platinum in the Competitive Mode.", Arrays.asList("", "600/1800", "", "+1")));
        achievements.add(new Achievement("Crazy Diamond!", "Raise your Rank up to Diamond in the Competitive Mode. Shine on!", Arrays.asList("", "1000/3000", "", "+1")));
        ...
        achievements.add(new Achievement("True hero", "Be in top 100 list of best ranked players. You can see your current position in the ranking section of your inventory.", Arrays.asList("", "800/2400")));
        achievements.add(new Achievement("We are the champions!", "Join the top 15 players featured in the Hall of Champions.", Arrays.asList("", "1200/3600")));
        achievements.add(new Achievement("The number one!", "Get to the top of the Ranking leaderboard.", Arrays.asList("", "2000/6000")));
        ...
        achievements.add(new Achievement("A story to be told", "Listen to what the Dude has to say at 5-3 prologue about the turbulent portal crossing.", Arrays.asList("", "500/1500")));
