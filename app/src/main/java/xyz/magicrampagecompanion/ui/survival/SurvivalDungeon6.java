...
public class SurvivalDungeon6 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_survival_dungeon6);

        // Apply system bar padding (status + navigation)
    ...
    private void applySystemInsets(View scrollViewOrNull, View contentRootOrNull) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(root, (v, insets) -> {
            ...
            // Push content below status bar / camera cutout
            ...
            // Keep scrollable bottom content above gesture nav bar
