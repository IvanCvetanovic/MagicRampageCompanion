...
public class ItemData {
    ...
    public static void init(Context context) {
        ...
        swordList.add(new Weapon(str(context, R.string.light_piercer), WeaponTypes.SWORD, Elements.LIGHT, 85, 391, 15, 25, 7, 3, R.drawable.sword_light_piercer, 550, 1, false, true, false, false));
        ...
        swordList.add(new Weapon(str(context, R.string.volcano_sword), WeaponTypes.SWORD, Elements.FIRE, 94, 432, 15, 25, 5, 0, R.drawable.sword_volcano_sword, 500, 1, false, true, false, false));
        ...
        staffList.add(new Weapon(str(context, R.string.compendium_of_trees), WeaponTypes.STAFF, Elements.EARTH, 48, 220, 15, 20, 3, 0, R.drawable.grimoire_compendium_of_trees, 550, 1, true, false, false, false));
        ...
        staffList.add(new Weapon(str(context, R.string.legacy_of_the_oracle), WeaponTypes.STAFF, Elements.EARTH, 80, 368, 15, 15, 3, 2, R.drawable.staff_legacy_of_the_oracle, 600, 1, true, true, false, false));
        ...
        staffList.add(new Weapon(str(context, R.string.seabane), WeaponTypes.STAFF, Elements.WATER, 84, 386, 15, 20, 4, 2, R.drawable.staff_seabane, 610, 1, true, true, false, false));
        ...
        axeList.add(new Weapon(str(context, R.string.dawnlight), WeaponTypes.AXE, Elements.LIGHT, 77, 354, 15, 50, 4, 2, R.drawable.axe_dawnlight, 450, 1, true, true, false, false));
        axeList.add(new Weapon(str(context, R.string.stormcaller), WeaponTypes.AXE, Elements.WATER, 77, 354, 15, 30, 3, 3, R.drawable.axe_stormcaller, 600, 1, true, true, false, false));
