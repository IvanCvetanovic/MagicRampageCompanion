...
public class ItemData {
    ...
    public static void init(Context context) {
        ...
        swordList.add(new Weapon(str(context, R.string.fire_sword), WeaponTypes.SWORD, Elements.FIRE, 8, 13, 3, 0, 4, 0, R.drawable.sword_recruit_fire_sword, 700, 0, true, false, false, false));
        swordList.add(new Weapon(str(context, R.string.steel_blade), WeaponTypes.SWORD, Elements.NEUTRAL, 11, 18, 3, 15, 5, 0, R.drawable.sword_steel_blade, 650, 0, true, false, false, false));
        swordList.add(new Weapon(str(context, R.string.master_sword), WeaponTypes.SWORD, Elements.AIR, 14, 24, 3, 20, 4, 2, R.drawable.sword_master_sword, 650, 0, true, false, false, false));
        swordList.add(new Weapon(str(context, R.string.vorpal_sword), WeaponTypes.SWORD, Elements.NEUTRAL, 25, 43, 3, 40, 6, 0, R.drawable.sword_vorpal_sword, 400, 0, true, false, false, false));
        swordList.add(new Weapon(str(context, R.string.pirate_sword), WeaponTypes.SWORD, Elements.NEUTRAL, 26, 44, 3, 10, 6, 4, R.drawable.sword_pirate_sword, 500, 0, true, false, false, false));
        swordList.add(new Weapon(str(context, R.string.nobel_sword), WeaponTypes.SWORD, Elements.NEUTRAL, 29, 49, 3, 30, 4, 0, R.drawable.sword_nobel_sword, 400, 0, true, false, false, false));
        ...
        swordList.add(new Weapon(str(context, R.string.leaf_sword), WeaponTypes.SWORD, Elements.EARTH, 23, 72, 9, 25, 3, 2, R.drawable.sword_leaf_sword, 400, 0, true, false, false, false));
        swordList.add(new Weapon(str(context, R.string.magicsaber), WeaponTypes.SWORD, Elements.LIGHT, 27, 111, 13, 0, 3, 3, R.drawable.sword_magicsaber, 600, 0, true, false, false, false));
        swordList.add(new Weapon(str(context, R.string.darkskull_sword), WeaponTypes.SWORD, Elements.DARKNESS, 32, 124, 12, 20, 4, 0, R.drawable.sword_fireskull_darkskull_sword, 600, 0, true, false, false, false));
        swordList.add(new Weapon(str(context, R.string.umbranian_long_sword), WeaponTypes.SWORD, Elements.AIR, 38, 129, 10, 45, 7, 2, R.drawable.sword_umbranian_long_sword, 450, 0, true, false, false, false));
        swordList.add(new Weapon(str(context, R.string.umbranian_short_sword), WeaponTypes.SWORD, Elements.NEUTRAL, 32, 131, 13, 50, 7, 0, R.drawable.sword_umbranian_short_sword, 300, 0, true, false, false, false));
        swordList.add(new Weapon(str(context, R.string.fireskull_sword), WeaponTypes.SWORD, Elements.FIRE, 36, 139, 12, 30, 6, 0, R.drawable.sword_fireskull_darkskull_sword, 500, 0, true, false, false, false));
        ...
        swordList.add(new Weapon(str(context, R.string.cthulhu_blade), WeaponTypes.SWORD, Elements.NEUTRAL, 90, 414, 15, 35, 7, 3, R.drawable.sword_cthulhu_blade, 550, 1, false, true, true, false));
        swordList.add(new Weapon(str(context, R.string.blade_of_the_wicked), WeaponTypes.SWORD, Elements.NEUTRAL, 90, 414, 15, 0, 7, 4, R.drawable.sword_blade_of_the_wicked, 470, 1, true, true, true, false));
        swordList.add(new Weapon(str(context, R.string.goldsteel), WeaponTypes.SWORD, Elements.NEUTRAL, 90, 414, 15, 30, 5, 2, R.drawable.sword_goldsteel, 500, 0, true, false, false, false));
        swordList.add(new Weapon(str(context, R.string.bunny_claymore), WeaponTypes.SWORD, Elements.NEUTRAL, 92, 423, 15, 30, 6, 10, R.drawable.sword_bunny_claymore, 500, 0, true, false, false, false));
        swordList.add(new Weapon(str(context, R.string.golden_needle), WeaponTypes.SWORD, Elements.NEUTRAL, 94, 432, 15, 0, 6, 2, R.drawable.sword_golden_needle, 575, 2, false, false, false, false));
        ...
        swordList.add(new Weapon(str(context, R.string.all_seeing_sword), WeaponTypes.SWORD, Elements.DARKNESS, 120, 552, 15, 30, 2, 5, R.drawable.sword_all_seeing_sword, 700, 1, true, false, false, false));
        ...
        swordList.add(new Weapon(str(context, R.string.blade_of_survival), WeaponTypes.SWORD, Elements.NEUTRAL, 120, 552, 15, 40, 0, 0, R.drawable.sword_blade_of_survival, 800, 0, true, true, false, false));
        swordList.add(new Weapon(str(context, R.string.unleashed_kraken), WeaponTypes.SWORD, Elements.WATER, 130, 598, 15, 25, 2, 1, R.drawable.sword_unleashed_kraken, 550, 0, true, true, false, false));

        // Daggers
        daggerList.add(new Weapon(str(context, R.string.iron_dagger), WeaponTypes.DAGGER, Elements.NEUTRAL, 4, 6, 3, 0, 5, 0, R.drawable.dagger_iron_fire_dagger, 450, 0, true, false, false, false));
        daggerList.add(new Weapon(str(context, R.string.fire_dagger), WeaponTypes.DAGGER, Elements.FIRE, 7, 12, 3, 0, 6, 0, R.drawable.dagger_iron_fire_dagger, 600, 0, true, false, false, false));
        daggerList.add(new Weapon(str(context, R.string.machete), WeaponTypes.DAGGER, Elements.NEUTRAL, 8, 13, 3, 0, 7, 0, R.drawable.dagger_machete, 500, 0, true, false, false, false));
        daggerList.add(new Weapon(str(context, R.string.chef_knife), WeaponTypes.DAGGER, Elements.NEUTRAL, 9, 15, 3, 0, 4, 2, R.drawable.dagger_chef_knife, 500, 0, true, false, false, false));
        daggerList.add(new Weapon(str(context, R.string.steel_dagger), WeaponTypes.DAGGER, Elements.NEUTRAL, 16, 27, 3, 0, 6, 3, R.drawable.dagger_steel_dagger, 450, 0, true, false, false, false));
        daggerList.add(new Weapon(str(context, R.string.kunai), WeaponTypes.DAGGER, Elements.DARKNESS, 11, 45, 13, 0, 16, 3, R.drawable.dagger_kunai, 500, 0, true, false, false, false));
        daggerList.add(new Weapon(str(context, R.string.poisoned_dagger), WeaponTypes.DAGGER, Elements.EARTH, 10, 48, 16, 0, 20, 4, R.drawable.dagger_poisoned_dagger, 400, 0, true, false, true, false));
        daggerList.add(new Weapon(str(context, R.string.poisoned_dart), WeaponTypes.DAGGER, Elements.NEUTRAL, 15, 72, 16, 0, 20, 4, R.drawable.dagger_poisoned_dart, 300, 0, true, false, true, false));
        daggerList.add(new Weapon(str(context, R.string.light_dagger), WeaponTypes.DAGGER, Elements.LIGHT, 12, 75, 22, 0, 10, 10, R.drawable.dagger_light_dagger, 400, 0, true, false, false, false));
        daggerList.add(new Weapon(str(context, R.string.gorgon_dagger), WeaponTypes.DAGGER, Elements.EARTH, 24, 98, 13, 30, 15, 2, R.drawable.dagger_gorgon_dagger, 600, 1, true, false, true, false));
        daggerList.add(new Weapon(str(context, R.string.ifrits_dagger), WeaponTypes.DAGGER, Elements.FIRE, 22, 101, 15, 0, 20, 2, R.drawable.dagger_ifrits_dagger, 400, 0, true, false, false, false));
        daggerList.add(new Weapon(str(context, R.string.dagger_of_sand), WeaponTypes.DAGGER, Elements.AIR, 32, 131, 13, 0, 20, 2, R.drawable.dagger_dagger_of_sand, 384, 0, true, false, false, false));
        daggerList.add(new Weapon(str(context, R.string.dark_dagger), WeaponTypes.DAGGER, Elements.DARKNESS, 36, 148, 13, 0, 25, 2, R.drawable.dagger_dark_dagger, 360, 0, true, false, false, false));
        daggerList.add(new Weapon(str(context, R.string.precious_skewer), WeaponTypes.DAGGER, Elements.NEUTRAL, 35, 161, 15, 0, 30, 3, R.drawable.dagger_precious_skewer, 360, 0, true, false, false, false));
        daggerList.add(new Weapon(str(context, R.string.dark_dagger_plus), WeaponTypes.DAGGER, Elements.DARKNESS, 40, 164, 13, 0, 25, 3, R.drawable.dagger_dark_dagger, 330, 0, true, false, false, false));
        daggerList.add(new Weapon(str(context, R.string.last_survivors_dagger), WeaponTypes.DAGGER, Elements.NEUTRAL, 36, 165, 15, 0, 20, 3, R.drawable.dagger_last_survivors_dagger, 300, 0, true, false, false, false));
        ...
        daggerList.add(new Weapon(str(context, R.string.gayan), WeaponTypes.DAGGER, Elements.EARTH, 42, 183, 14, 30, 27, 4, R.drawable.dagger_gayan, 360, 0, true, false, false, false));
        ...
        daggerList.add(new Weapon(str(context, R.string.sapphire_pawns_dagger), WeaponTypes.DAGGER, Elements.NEUTRAL, 42, 193, 15, 0, 20, 0, R.drawable.dagger_sapphire_pawns_dagger, 500, 0, true, false, false, true));
        ...
        daggerList.add(new Weapon(str(context, R.string.undines_dagger), WeaponTypes.DAGGER, Elements.WATER, 50, 206, 13, 0, 25, 4, R.drawable.dagger_undines_dagger, 500, 0, true, false, true, false));
        daggerList.add(new Weapon(str(context, R.string.venomous_dagger), WeaponTypes.DAGGER, Elements.NEUTRAL, 46, 211, 15, 0, 18, 2, R.drawable.dagger_venomous_dagger, 400, 1, true, false, true, false));
        daggerList.add(new Weapon(str(context, R.string.dragon_tooth_dagger), WeaponTypes.DAGGER, Elements.NEUTRAL, 48, 220, 15, -40, 25, 10, R.drawable.dagger_dragon_tooth_dagger, 360, 1, true, false, false, false));
        ...
        daggerList.add(new Weapon(str(context, R.string.iron_dagger_plus), WeaponTypes.DAGGER, Elements.NEUTRAL, 50, 230, 15, -30, 25, 0, R.drawable.dagger_iron_dagger_plus, 440, 1, true, false, false, false));
        daggerList.add(new Weapon(str(context, R.string.cthulhu_dagger), WeaponTypes.DAGGER, Elements.DARKNESS, 52, 239, 15, 0, 20, 3, R.drawable.dagger_cthulhu_dagger, 400, 2, true, false, true, false));
        daggerList.add(new Weapon(str(context, R.string.malicious_quickblade), WeaponTypes.DAGGER, Elements.NEUTRAL, 48, 220, 15, -20, 20, 5, R.drawable.dagger_malicious_quickblade, 450, 1, true, false, true, false));
        daggerList.add(new Weapon(str(context, R.string.all_seeing_cleaver), WeaponTypes.DAGGER, Elements.NEUTRAL, 52, 239, 15, -15, 25, 3, R.drawable.dagger_all_seeing_cleaver, 360, 1, true, false, false, false));
        daggerList.add(new Weapon(str(context, R.string.ruby_pawns_edge), WeaponTypes.DAGGER, Elements.NEUTRAL, 58, 266, 15, -20, 25, 0, R.drawable.dagger_ruby_pawns_edge, 440, 0, true, true, true, false));
        ...
        daggerList.add(new Weapon(str(context, R.string.ifrits_shuriken), WeaponTypes.DAGGER, Elements.FIRE, 74, 340, 15, -20, 15, 3, R.drawable.shuriken_ifrits_shuriken, 340, 0, true, false, true, false));
        daggerList.add(new Weapon(str(context, R.string.undines_shuriken), WeaponTypes.DAGGER, Elements.WATER, 76, 349, 15, -20, 15, 3, R.drawable.shuriken_undines_shuriken, 360, 0, true, false, false, true));
        daggerList.add(new Weapon(str(context, R.string.gayan_shuriken), WeaponTypes.DAGGER, Elements.EARTH, 80, 368, 15, -10, 15, 3, R.drawable.shuriken_gayan_shuriken, 340, 0, true, false, false, false));
        ...
        // Hammers
        hammerList.add(new Weapon(str(context, R.string.wooden_hawaiian), WeaponTypes.HAMMER, Elements.NEUTRAL, 10, 17, 3, 0, 0, 0, R.drawable.mace_wooden_hawaiian, 800, 0, true, false, false, false));
        hammerList.add(new Weapon(str(context, R.string.silver_mace), WeaponTypes.HAMMER, Elements.NEUTRAL, 12, 20, 3, 35, 0, 0, R.drawable.mace_silver_dark_mace, 800, 0, true, true, false, false));
        hammerList.add(new Weapon(str(context, R.string.club), WeaponTypes.HAMMER, Elements.NEUTRAL, 16, 27, 3, 30, 0, 0, R.drawable.mace_club, 800, 0, true, true, false, false));
        hammerList.add(new Weapon(str(context, R.string.iron_mace), WeaponTypes.HAMMER, Elements.NEUTRAL, 16, 27, 3, 30, 0, 0, R.drawable.mace_iron_mace, 800, 0, true, true, false, false));
        hammerList.add(new Weapon(str(context, R.string.insect_crusher), WeaponTypes.HAMMER, Elements.NEUTRAL, 16, 27, 3, 35, 0, 0, R.drawable.hammer_insect_crusher, 800, 0, true, true, false, false));
        hammerList.add(new Weapon(str(context, R.string.wooden_hammer), WeaponTypes.HAMMER, Elements.EARTH, 17, 41, 6, 35, 0, 0, R.drawable.hammer_wooden_hammer, 800, 0, true, true, false, false));
        hammerList.add(new Weapon(str(context, R.string.bionic_hammer), WeaponTypes.HAMMER, Elements.NEUTRAL, 38, 65, 3, 35, 0, 6, R.drawable.hammer_bionic_hammer, 500, 0, true, true, false, false));
        hammerList.add(new Weapon(str(context, R.string.warhammer), WeaponTypes.HAMMER, Elements.NEUTRAL, 28, 108, 12, 50, 0, 0, R.drawable.hammer_warhammer, 800, 0, true, true, false, false));
        hammerList.add(new Weapon(str(context, R.string.dark_mace), WeaponTypes.HAMMER, Elements.DARKNESS, 35, 127, 11, 50, 2, 1, R.drawable.mace_silver_dark_mace, 700, 0, true, true, false, false));
        hammerList.add(new Weapon(str(context, R.string.spider_crusher), WeaponTypes.HAMMER, Elements.EARTH, 47, 159, 10, 35, 0, 2, R.drawable.hammer_spider_crusher, 800, 0, true, true, false, false));
        hammerList.add(new Weapon(str(context, R.string.inquisidor), WeaponTypes.HAMMER, Elements.DARKNESS, 40, 164, 13, 50, 1, 1, R.drawable.hammer_inquisidor, 700, 0, true, true, false, false));
        hammerList.add(new Weapon(str(context, R.string.thunder_hammer), WeaponTypes.HAMMER, Elements.NEUTRAL, 70, 204, 8, 45, 0, 2, R.drawable.hammer_thunder_hammer, 800, 0, true, true, false, false));
        ...
        hammerList.add(new Weapon(str(context, R.string.toxic_mace), WeaponTypes.HAMMER, Elements.NEUTRAL, 46, 211, 15, 50, 2, 0, R.drawable.mace_toxic_mace, 600, 0, true, true, true, false));
        ...
        hammerList.add(new Weapon(str(context, R.string.falcon_hammer), WeaponTypes.HAMMER, Elements.AIR, 45, 217, 16, 60, 9, 2, R.drawable.hammer_falcon_hammer, 1050, 1, true, true, false, false));
        ...
        hammerList.add(new Weapon(str(context, R.string.volcano_hammer), WeaponTypes.HAMMER, Elements.FIRE, 47, 227, 16, 80, 0, 0, R.drawable.hammer_volcano_hammer, 1050, 1, true, true, false, false));
        hammerList.add(new Weapon(str(context, R.string.verdant_hammer), WeaponTypes.HAMMER, Elements.EARTH, 48, 232, 16, 80, 0, 3, R.drawable.hammer_verdant_hammer, 1050, 1, true, true, false, false));
        hammerList.add(new Weapon(str(context, R.string.smasher_of_decay), WeaponTypes.HAMMER, Elements.NEUTRAL, 52, 239, 15, 50, 0, 0, R.drawable.hammer_smasher_of_decay, 900, 0, true, true, false, false));
        hammerList.add(new Weapon(str(context, R.string.mojaras_hammer), WeaponTypes.HAMMER, Elements.DARKNESS, 55, 266, 16, 70, 2, 2, R.drawable.hammer_mojaras_hammer, 1050, 1, true, true, false, false));
        hammerList.add(new Weapon(str(context, R.string.war_forged_smasher), WeaponTypes.HAMMER, Elements.FIRE, 64, 294, 15, 70, 0, 0, R.drawable.hammer_war_forged_smasher, 700, 1, true, true, false, false));
        ...
        hammerList.add(new Weapon(str(context, R.string.wit_of_ancient_power), WeaponTypes.HAMMER, Elements.NEUTRAL, 56, 271, 16, 80, 0, 0, R.drawable.hammer_wit_of_ancient_power, 1400, 1, true, true, false, false));
        hammerList.add(new Weapon(str(context, R.string.enlightened_hammer), WeaponTypes.HAMMER, Elements.LIGHT, 64, 294, 15, 60, 0, 0, R.drawable.hammer_enlightened_hammer, 650, 2, true, true, false, false));

        // Staffs
        staffList.add(new Weapon(str(context, R.string.nature_staff), WeaponTypes.STAFF, Elements.EARTH, 8, 13, 3, 0, 0, 0, R.drawable.staff_nature_gadarasts_staff, 800, 0, true, false, false, false));
        staffList.add(new Weapon(str(context, R.string.fire_staff), WeaponTypes.STAFF, Elements.FIRE, 10, 17, 3, 0, 0, 0, R.drawable.staff_fire_staff, 800, 0, true, false, false, false));
        staffList.add(new Weapon(str(context, R.string.light_staff), WeaponTypes.STAFF, Elements.LIGHT, 12, 20, 3, 0, 1, 1, R.drawable.staff_light_staff, 800, 0, true, false, false, false));
        staffList.add(new Weapon(str(context, R.string.oxymos_staff), WeaponTypes.STAFF, Elements.LIGHT, 21, 96, 15, 0, 0, 2, R.drawable.staff_oxymos_staff, 600, 0, true, true, false, false));
        staffList.add(new Weapon(str(context, R.string.gadarasts_staff), WeaponTypes.STAFF, Elements.EARTH, 32, 108, 10, 30, 1, 2, R.drawable.staff_nature_gadarasts_staff, 700, 0, true, false, false, false));
        staffList.add(new Weapon(str(context, R.string.staff_of_darkness), WeaponTypes.STAFF, Elements.DARKNESS, 41, 149, 11, 0, 2, 2, R.drawable.staff_staff_of_darkness, 700, 0, true, false, false, false));
        staffList.add(new Weapon(str(context, R.string.firebane), WeaponTypes.STAFF, Elements.FIRE, 41, 149, 11, 0, 2, 2, R.drawable.staff_firebane, 700, 0, true, true, false, false));
        staffList.add(new Weapon(str(context, R.string.the_testament_of_ifrit), WeaponTypes.STAFF, Elements.FIRE, 38, 174, 15, 0, 7, 0, R.drawable.grimoire_the_testament_of_ifrit, 400, 4, true, false, false, false));
        staffList.add(new Weapon(str(context, R.string.epic_fire_staff), WeaponTypes.STAFF, Elements.FIRE, 49, 178, 11, 0, 3, 1, R.drawable.staff_epic_fire_staff, 750, 0, true, false, false, false));
        ...
        staffList.add(new Weapon(str(context, R.string.compendium_of_trees), WeaponTypes.STAFF, Elements.EARTH, 52, 239, 15, 20, 4, 2, R.drawable.grimoire_compendium_of_trees, 550, 1, true, false, false, false));
        staffList.add(new Weapon(str(context, R.string.dragon_orb_staff), WeaponTypes.STAFF, Elements.FIRE, 48, 197, 13, 0, 1, 1, R.drawable.staff_dragon_orb_staff, 500, 0, true, true, false, false));
        ...
        staffList.add(new Weapon(str(context, R.string.the_abyssal_scrolls), WeaponTypes.STAFF, Elements.WATER, 52, 239, 15, 0, 5, 0, R.drawable.grimoire_the_abyssal_scrolls, 500, 3, true, false, false, false));
        staffList.add(new Weapon(str(context, R.string.the_ancient_codices), WeaponTypes.STAFF, Elements.NEUTRAL, 50, 230, 15, 0, 4, 6, R.drawable.grimoire_the_ancient_codices, 450, 0, false, false, false, false));
        ...
        staffList.add(new Weapon(str(context, R.string.nightfall), WeaponTypes.STAFF, Elements.DARKNESS, 62, 285, 15, 0, 2, 4, R.drawable.staff_nightfall, 630, 1, true, true, false, true));
        staffList.add(new Weapon(str(context, R.string.tome_of_the_sands), WeaponTypes.STAFF, Elements.AIR, 66, 303, 15, -50, 10, 0, R.drawable.grimoire_tome_of_the_sands, 450, 2, true, false, false, false));
        staffList.add(new Weapon(str(context, R.string.hippie_dragon_staff_plus), WeaponTypes.STAFF, Elements.EARTH, 70, 322, 15, 40, 5, 3, R.drawable.staff_hippie_dragon_staff, 550, 0, true, true, false, false));
        staffList.add(new Weapon(str(context, R.string.dragonskull_staff), WeaponTypes.STAFF, Elements.FIRE, 72, 331, 15, 0, 5, 1, R.drawable.staff_dragonskull_staff, 650, 0, true, true, false, false));
        staffList.add(new Weapon(str(context, R.string.legacy_of_the_oracle), WeaponTypes.STAFF, Elements.EARTH, 85, 391, 15, 15, 3, 6, R.drawable.staff_legacy_of_the_oracle, 600, 1, true, true, false, false));
        staffList.add(new Weapon(str(context, R.string.royal_war_staff), WeaponTypes.STAFF, Elements.NEUTRAL, 72, 331, 15, 20, 3, 2, R.drawable.staff_royal_war_staff, 600, 0, true, true, false, false));
        staffList.add(new Weapon(str(context, R.string.hippie_dragon_staff), WeaponTypes.STAFF, Elements.EARTH, 75, 345, 15, 30, 2, 2, R.drawable.staff_hippie_dragon_staff, 650, 0, true, true, false, false));
        staffList.add(new Weapon(str(context, R.string.seabane), WeaponTypes.STAFF, Elements.WATER, 95, 437, 15, 15, 4, 3, R.drawable.staff_seabane, 700, 1, true, true, false, false));
        staffList.add(new Weapon(str(context, R.string.golden_dragon_staff), WeaponTypes.STAFF, Elements.LIGHT, 76, 349, 15, 20, 3, 2, R.drawable.staff_golden_dragon_staff, 650, 0, true, true, false, false));
        ...
        staffList.add(new Weapon(str(context, R.string.death_scythe), WeaponTypes.STAFF, Elements.DARKNESS, 80, 368, 15, 0, 2, 1, R.drawable.staff_death_scythe, 650, 0, true, true, false, false));
        staffList.add(new Weapon(str(context, R.string.water_staff), WeaponTypes.STAFF, Elements.WATER, 80, 368, 15, 0, 3, 3, R.drawable.staff_water_staff, 650, 0, true, true, false, false));
        staffList.add(new Weapon(str(context, R.string.death_scythe_plus), WeaponTypes.STAFF, Elements.DARKNESS, 85, 391, 15, 0, 2, 3, R.drawable.staff_death_scythe, 450, 1, true, true, false, false));
        staffList.add(new Weapon(str(context, R.string.windbane), WeaponTypes.STAFF, Elements.AIR, 75, 345, 15, 0, 8, 2, R.drawable.staff_windbane, 700, 2, true, true, false, false));
        staffList.add(new Weapon(str(context, R.string.toxic_staff), WeaponTypes.STAFF, Elements.EARTH, 90, 414, 15, 0, 5, 2, R.drawable.staff_toxic_staff, 450, 0, true, true, true, false));
        staffList.add(new Weapon(str(context, R.string.dragonskull_staff_plus), WeaponTypes.STAFF, Elements.FIRE, 95, 437, 15, 0, 4, 4, R.drawable.staff_dragonskull_staff, 550, 1, true, true, false, false));
        staffList.add(new Weapon(str(context, R.string.golden_dragon_staff_plus), WeaponTypes.STAFF, Elements.LIGHT, 90, 414, 15, 20, 4, 3, R.drawable.staff_golden_dragon_staff, 650, 1, true, true, false, false));
        staffList.add(new Weapon(str(context, R.string.spider_staff), WeaponTypes.STAFF, Elements.DARKNESS, 97, 446, 15, 0, 4, 4, R.drawable.staff_spider_staff, 550, 1, true, true, true, false));
        staffList.add(new Weapon(str(context, R.string.dead_vulture_staff), WeaponTypes.STAFF, Elements.DARKNESS, 95, 437, 15, 0, 2, 1, R.drawable.staff_dead_vulture_staff, 650, 1, true, true, false, false));
        staffList.add(new Weapon(str(context, R.string.staff_of_the_wicked), WeaponTypes.STAFF, Elements.NEUTRAL, 110, 506, 15, 20, 3, 2, R.drawable.staff_staff_of_the_wicked, 400, 0, true, false, false, false));
        staffList.add(new Weapon(str(context, R.string.voidcaller_staff), WeaponTypes.STAFF, Elements.DARKNESS, 125, 575, 15, -30, 4, 5, R.drawable.staff_voidcaller_staff, 600, 1, false, false, false, false));
        staffList.add(new Weapon(str(context, R.string.ancient_stone_staff), WeaponTypes.STAFF, Elements.NEUTRAL, 120, 552, 15, 0, 0, 0, R.drawable.staff_ancient_stone_staff, 700, 0, true, false, false, false));

        // Spears
        spearList.add(new Weapon(str(context, R.string.obsidian_spear), WeaponTypes.SPEAR, Elements.NEUTRAL, 40, 164, 13, 20, 4, 3, R.drawable.spear_obsidian_spear, 750, 4, false, true, false, false));
        spearList.add(new Weapon(str(context, R.string.cthulhu_spear), WeaponTypes.SPEAR, Elements.DARKNESS, 55, 253, 15, 100, 0, 0, R.drawable.spear_cthulhu_spear, 750, 4, false, true, true, false));
        spearList.add(new Weapon(str(context, R.string.gayan_spear), WeaponTypes.SPEAR, Elements.EARTH, 53, 243, 15, 65, 3, 4, R.drawable.spear_gayan_spear, 750, 4, false, true, false, false));
        ...
        spearList.add(new Weapon(str(context, R.string.yansahn), WeaponTypes.SPEAR, Elements.AIR, 57, 262, 15, 0, 10, 4, R.drawable.spear_yansahn, 750, 4, false, true, false, false));
        spearList.add(new Weapon(str(context, R.string.fire_pierce), WeaponTypes.SPEAR, Elements.FIRE, 58, 266, 15, 0, 5, 3, R.drawable.spear_fire_pierce, 750, 4, false, true, false, false));
        spearList.add(new Weapon(str(context, R.string.freyr), WeaponTypes.SPEAR, Elements.LIGHT, 58, 266, 15, 40, 6, 7, R.drawable.spear_freyr, 750, 4, false, true, false, false));
        ...
        spearList.add(new Weapon(str(context, R.string.osun), WeaponTypes.SPEAR, Elements.WATER, 64, 294, 15, 20, 5, 4, R.drawable.spear_osun, 750, 4, false, true, false, false));
        spearList.add(new Weapon(str(context, R.string.gorgon_spear), WeaponTypes.SPEAR, Elements.NEUTRAL, 60, 276, 15, 0, 10, 0, R.drawable.spear_gorgon_spear, 650, 4, true, true, true, false));
        spearList.add(new Weapon(str(context, R.string.azatoth), WeaponTypes.SPEAR, Elements.DARKNESS, 67, 308, 15, 30, 5, 3, R.drawable.spear_azatoth, 750, 4, false, true, false, false));
        ...
        // Axes
        axeList.add(new Weapon(str(context, R.string.silver_axe), WeaponTypes.AXE, Elements.NEUTRAL, 19, 32, 3, 35, 0, 0, R.drawable.axe_silver_fire_lightning_axe, 800, 0, true, false, false, false));
        axeList.add(new Weapon(str(context, R.string.umbranian_cutter), WeaponTypes.AXE, Elements.NEUTRAL, 35, 60, 3, 30, 0, 0, R.drawable.axe_umbranian_flaming_cutter, 800, 0, true, true, false, false));
        axeList.add(new Weapon(str(context, R.string.bone_chopper), WeaponTypes.AXE, Elements.AIR, 22, 69, 9, 35, 6, 3, R.drawable.axe_bone_chopper, 450, 0, true, false, false, false));
        axeList.add(new Weapon(str(context, R.string.axe_of_fire), WeaponTypes.AXE, Elements.FIRE, 21, 96, 15, 30, 3, 0, R.drawable.axe_silver_fire_lightning_axe, 600, 0, true, false, false, false));
        axeList.add(new Weapon(str(context, R.string.flaming_cutter), WeaponTypes.AXE, Elements.FIRE, 24, 110, 15, 40, 4, 1, R.drawable.axe_umbranian_flaming_cutter, 600, 0, true, false, false, false));
        ...
        axeList.add(new Weapon(str(context, R.string.spider_axe), WeaponTypes.AXE, Elements.FIRE, 40, 164, 13, 30, 3, 3, R.drawable.axe_spider_axe, 600, 0, true, true, true, false));
        ...
        axeList.add(new Weapon(str(context, R.string.eggscellent_axe), WeaponTypes.AXE, Elements.NEUTRAL, 52, 239, 15, 30, 3, 17, R.drawable.axe_eggscellent_axe, 500, 0, true, true, false, false));
        axeList.add(new Weapon(str(context, R.string.axe_of_rusted_gods), WeaponTypes.AXE, Elements.NEUTRAL, 53, 243, 15, 35, 0, 0, R.drawable.axe_axe_of_rusted_gods, 800, 0, true, true, false, false));
        ...
        axeList.add(new Weapon(str(context, R.string.ice_axe), WeaponTypes.AXE, Elements.NEUTRAL, 70, 322, 15, 30, 2, 5, R.drawable.axe_ice_axe, 450, 0, true, false, false, true));
        axeList.add(new Weapon(str(context, R.string.cthulhu_axe), WeaponTypes.AXE, Elements.DARKNESS, 78, 358, 15, 40, 4, 3, R.drawable.axe_cthulhu_axe, 600, 1, true, true, true, false));
        ...
        axeList.add(new Weapon(str(context, R.string.dawnlight), WeaponTypes.AXE, Elements.LIGHT, 80, 368, 15, 50, 4, 4, R.drawable.axe_dawnlight, 450, 1, true, true, false, false));
        axeList.add(new Weapon(str(context, R.string.stormcaller), WeaponTypes.AXE, Elements.WATER, 85, 391, 15, 30, 3, 3, R.drawable.axe_stormcaller, 600, 1, true, true, false, false));
        ...
        axeList.add(new Weapon(str(context, R.string.gorgon_axe), WeaponTypes.AXE, Elements.EARTH, 92, 423, 15, 40, 6, 1, R.drawable.axe_gorgon_axe, 600, 1, true, false, true, false));
        axeList.add(new Weapon(str(context, R.string.all_seeing_axe), WeaponTypes.AXE, Elements.DARKNESS, 105, 483, 15, 50, 3, 3, R.drawable.axe_all_seeing_axe, 600, 1, true, true, false, false));
        ...
        armorList.add(new Armor(str(context, R.string.minion_vest), Elements.NEUTRAL, false, 0, 0, 3, 0, 0, 0, 0, 0, 0, 0, 0, 0, R.drawable.armor_minion_warlock_vest));
        armorList.add(new Armor(str(context, R.string.recruit_set), Elements.NEUTRAL, false, 6, 10, 3, 0, 0, 0, 10, 0, 15, 0, 0, 0, R.drawable.armor_recruit_soldier_set));
        ...
        armorList.add(new Armor(str(context, R.string.cleric_vest), Elements.LIGHT, false, 8, 13, 3, 2, 2, 35, 0, 20, 20, 0, 0, 0, R.drawable.armor_cleric_vest));
        armorList.add(new Armor(str(context, R.string.nature_mage_vest), Elements.EARTH, false, 8, 13, 3, 0, 0, 30, 0, 20, 0, 0, 0, 0, R.drawable.armor_nature_mage_vest));
        armorList.add(new Armor(str(context, R.string.fire_mage_vest), Elements.FIRE, false, 8, 13, 3, 0, 0, 30, 0, 20, 0, 0, 0, 0, R.drawable.armor_fire_mage_vest));
        ...
        armorList.add(new Armor(str(context, R.string.soldier_set), Elements.NEUTRAL, false, 12, 20, 3, 0, 0, 0, 20, 0, 20, 15, 0, 0, R.drawable.armor_recruit_soldier_set));
        armorList.add(new Armor(str(context, R.string.plague_fighter_suit), Elements.AIR, false, 14, 24, 3, 4, 3, 0, 0, 0, 20, 0, 0, 0, R.drawable.armor_plague_fighter_suit));
        armorList.add(new Armor(str(context, R.string.elite_soldier_set), Elements.NEUTRAL, false, 15, 25, 3, 3, 2, 0, 30, 0, 20, 20, 0, 0, R.drawable.armor_elite_soldier_set));
        ...
        armorList.add(new Armor(str(context, R.string.ranger_set), Elements.AIR, false, 19, 32, 3, 3, 2, 0, 30, 0, 30, 0, 0, 0, R.drawable.armor_ranger_umbranian_set));
        armorList.add(new Armor(str(context, R.string.umbranian_vest), Elements.AIR, false, 21, 36, 3, 5, 3, 30, 20, 0, 40, 0, 0, 0, R.drawable.armor_ranger_umbranian_set));
        ...
        armorList.add(new Armor(str(context, R.string.brass_set), Elements.NEUTRAL, false, 30, 51, 3, 1, 1, 0, 15, 0, 0, 20, 20, 0, R.drawable.armor_brass_set));
        ...
        armorList.add(new Armor(str(context, R.string.elite_brass_set), Elements.NEUTRAL, false, 36, 61, 3, 2, 2, 0, 20, 0, 0, 25, 25, 0, R.drawable.armor_elite_brass_set));
        ...
        armorList.add(new Armor(str(context, R.string.obsidian_set), Elements.NEUTRAL, false, 42, 72, 3, 2, 2, 0, 25, 0, 0, 30, 30, 0, R.drawable.armor_obsidian_set));
        ...
        armorList.add(new Armor(str(context, R.string.antiheros_set), Elements.AIR, false, 33, 104, 9, 7, 5, 65, 60, 0, 60, 65, 0, 0, R.drawable.armor_antiheros_set));
        ...
        armorList.add(new Armor(str(context, R.string.warlock_vest), Elements.DARKNESS, false, 22, 90, 13, 4, 2, 50, 0, 30, 30, 0, 0, 0, R.drawable.armor_minion_warlock_vest));
        armorList.add(new Armor(str(context, R.string.elite_obsidian_set), Elements.NEUTRAL, false, 53, 91, 3, 3, 2, 0, 35, 0, 0, 35, 35, 0, R.drawable.armor_elite_obsidian_set));
        ...
        armorList.add(new Armor(str(context, R.string.storm), Elements.AIR, false, 20, 92, 15, 7, 4, 130, 0, 170, 0, 170, 0, 0, R.drawable.armor_storm));
        ...
        armorList.add(new Armor(str(context, R.string.wind_witch_suit), Elements.AIR, false, 21, 96, 15, 6, 4, 140, 100, 0, 140, 0, 0, 140, R.drawable.armor_wind_witch_suit));
        armorList.add(new Armor(str(context, R.string.tunic_of_ending_nights), Elements.NEUTRAL, true, 21, 96, 15, 3, 2, 150, 0, 140, 100, 0, 0, 0, R.drawable.armor_tunic_of_ending_nights));
        ...
        armorList.add(new Armor(str(context, R.string.special_antiheros_set), Elements.AIR, false, 25, 103, 13, 8, 5, 60, 70, 0, 70, 0, 0, 0, R.drawable.armor_antiheros_set));
        armorList.add(new Armor(str(context, R.string.gorgons_skin), Elements.FIRE, false, 25, 103, 13, 6, 3, 100, 0, 0, 35, 0, 0, 60, R.drawable.armor_gorgons_skin));
        ...
        armorList.add(new Armor(str(context, R.string.tunic_of_endless_justice), Elements.LIGHT, false, 24, 110, 15, 5, 3, 180, 100, 130, 0, 0, 0, 100, R.drawable.armor_tunic_of_endless_justice));
        armorList.add(new Armor(str(context, R.string.barrenlands_banditin), Elements.NEUTRAL, false, 24, 110, 15, 2, 3, 100, 0, 150, 190, 120, 0, 0, R.drawable.armor_barrenlands_banditin));
        armorList.add(new Armor(str(context, R.string.spider_exoskeleton), Elements.DARKNESS, false, 27, 111, 13, 6, 3, 100, 0, 0, 35, 100, 0, 0, R.drawable.armor_spider_exoskeleton));
        ...
        armorList.add(new Armor(str(context, R.string.swamp_witch_suit), Elements.NEUTRAL, false, 34, 115, 10, 4, 4, 110, 130, 140, 80, 0, 0, 0, R.drawable.armor_swamp_witch_suit));
        armorList.add(new Armor(str(context, R.string.tunic_of_frozen_voices), Elements.WATER, true, 25, 115, 15, 0, 0, 170, 0, 140, 90, 0, 0, 150, R.drawable.armor_tunic_of_frozen_voices));
        armorList.add(new Armor(str(context, R.string.scarlet_shadowweaver), Elements.DARKNESS, false, 25, 115, 15, 4, 6, 130, 0, 130, 130, 0, 0, 0, R.drawable.armor_scarlet_shadowweaver));
        armorList.add(new Armor(str(context, R.string.special_crow_set), Elements.DARKNESS, false, 29, 119, 13, 6, 4, 80, 70, 0, 0, 60, 60, 0, R.drawable.armor_special_crow_set));
        armorList.add(new Armor(str(context, R.string.death_stalker), Elements.DARKNESS, false, 26, 119, 15, 2, 0, 160, 0, 110, 140, 0, 0, 150, R.drawable.armor_death_stalker));
        ...
        armorList.add(new Armor(str(context, R.string.barrenlands_bandit), Elements.NEUTRAL, false, 27, 124, 15, 2, 3, 60, 210, 0, 130, 0, 150, 0, R.drawable.armor_barrenlands_bandit));
        ...
        armorList.add(new Armor(str(context, R.string.penumbra_suit_plus), Elements.DARKNESS, false, 26, 125, 16, 6, 4, 140, 0, 50, 0, 0, 0, 60, R.drawable.armor_penumbra_suit));
        ...
        armorList.add(new Armor(str(context, R.string.dark_lord_set_plus), Elements.DARKNESS, false, 45, 131, 8, 6, 4, 130, 80, 0, 80, 0, 0, 80, R.drawable.armor_dark_lord_set));
        ...
        armorList.add(new Armor(str(context, R.string.bacoon_set_plus), Elements.WATER, false, 28, 135, 16, 5, 5, 75, 60, 0, 0, 0, 80, 60, R.drawable.armor_bacoon_set));
        ...
        armorList.add(new Armor(str(context, R.string.vest_of_twisted_illusions), Elements.DARKNESS, true, 34, 156, 15, 3, 0, 70, 0, 0, 0, 0, 0, 240, R.drawable.armor_vest_of_twisted_illusions));
        armorList.add(new Armor(str(context, R.string.fire_moonkeeper_set), Elements.FIRE, true, 35, 161, 15, 6, 3, 100, 0, 110, 100, 0, 0, 110, R.drawable.armor_fire_moonkeeper_set));
        armorList.add(new Armor(str(context, R.string.robe_of_imminent_fires), Elements.FIRE, false, 35, 161, 15, 3, 0, 140, 0, 110, 0, 190, 0, 130, R.drawable.armor_robe_of_imminent_fires));
        armorList.add(new Armor(str(context, R.string.tunic_of_distant_ancestors), Elements.EARTH, false, 36, 165, 15, 3, 2, 130, 0, 0, 200, 170, 0, 0, R.drawable.armor_tunic_of_distant_ancestors));
        ...
        armorList.add(new Armor(str(context, R.string.desert_rogue_suit), Elements.NEUTRAL, false, 50, 170, 10, 5, 2, 70, 0, 0, 130, 130, 0, 160, R.drawable.armor_desert_rogue_suit));
        ...
        armorList.add(new Armor(str(context, R.string.warden_of_demons), Elements.DARKNESS, false, 52, 239, 15, 0, 0, 80, 140, 0, 0, 140, 145, 0, R.drawable.armor_warden_of_demons));
        armorList.add(new Armor(str(context, R.string.destroyer_of_the_corrupted), Elements.LIGHT, false, 52, 239, 15, 0, 0, 80, 100, 0, 0, 140, 175, 0, R.drawable.armor_destroyer_of_the_corrupted));
        armorList.add(new Armor(str(context, R.string.vanquisher), Elements.AIR, false, 55, 253, 15, 0, 0, 70, 160, 0, 0, 0, 0, 170, R.drawable.armor_vanquisher));
        armorList.add(new Armor(str(context, R.string.cataclysmic_plate), Elements.FIRE, false, 56, 257, 15, -1, 0, 55, 140, 0, 0, 170, 220, 0, R.drawable.armor_cataclysmic_plate));
        ...
        ringList.add(new Ring(str(context, R.string.spektator), Elements.NEUTRAL, 30, 0, 5, 3, 110, 80, 80, 80, 0, 0, 80, R.drawable.ring_spektator));
        ringList.add(new Ring(str(context, R.string.ancient_warden), Elements.WATER, 30, 0, 4, 6, 100, 100, 100, 0, 0, 140, 0, R.drawable.ring_ancient_warden));
        ringList.add(new Ring(str(context, R.string.ghostwalker), Elements.NEUTRAL, 30, 150, 0, 0, 60, 0, 0, 0, 0, 0, 0, R.drawable.ring_ghostwalker));
        ...
        ringList.add(new Ring(str(context, R.string.tidecaller_ring), Elements.WATER, 30, 0, 4, 6, 100, 0, 0, 100, 100, 0, 100, R.drawable.ring_tidecaller_ring));
        ...
        ringList.add(new Ring(str(context, R.string.cuteulhu), Elements.NEUTRAL, 40, 0, 4, 4, 100, 0, 90, 0, 90, 90, 0, R.drawable.ring_cuteulhu));
        ...
        ringList.add(new Ring(str(context, R.string.phoenix), Elements.FIRE, 40, 0, 2, 3, 100, 0, 0, 90, 0, 130, 90, R.drawable.ring_phoenix));
        ringList.add(new Ring(str(context, R.string.vina), Elements.EARTH, 50, 0, 2, 3, 100, 100, 100, 0, 0, 0, 0, R.drawable.ring_vina));
