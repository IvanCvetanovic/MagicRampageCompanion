...
public class ItemData {
    ...
    public static void init(Context context) {
        ...
        daggerList.add(new Weapon(str(context, R.string.poisoned_dagger), WeaponTypes.DAGGER, Elements.EARTH, 15, 72, 16, 0, 20, 0, R.drawable.dagger_poisoned_dart, 300, 0, true, false, true, false, 5, 2, 0, 0, 0, 1, List.of(str(context, R.string.achievement))));
        ...
        armorList.add(new Armor(str(context, R.string.gorgons_skin), Elements.FIRE, false, 25, 103, 3, 6, 3, 100, 0, 0, 35, 0, 0, 60, R.drawable.armor_gorgons_skin, 75000, 38500, 0, 0, 8333, 16666, List.of(str(context, R.string.pvp_silver_purple_chest))));
